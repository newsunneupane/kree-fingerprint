    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          ...
          <p className={`text-2xl font-bold mt-2 ${todayPunches.length % 2 === 0 ? 'text-emerald-600' : 'text-amber-600'}`}>
            {todayPunches.length % 2 === 0 ? 'Clocked Out' : 'Clocked In'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6">
          <a href="/employee/clock-in" className="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            <span className="text-3xl">⏰</span>
            <span className="text-sm font-medium text-gray-700">Clock In</span>
          </a>
          <a href="/employee/clock-out" className="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            <span className="text-3xl">🔚</span>
